...
describe('Expression with now', function () {
    it('should parse expression with now', function () {
        ...
        helper.assertDateMathEquals('now/d', '2014-11-18T00:00:00', now, false, null);

        // timezone does not affect now
        helper.assertDateMathEquals('now/m', '2014-11-18T14:27', now, false, '+02:00');
        helper.assertDateMathEquals('now/d', '2014-11-18T00:00:00', now, false, '+02:00');

        // timezone takes affect
        helper.assertDateMathEquals('now/d', '2014-11-18T00:00:00+02:00', now, false, '+02:00', true);
